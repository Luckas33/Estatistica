...
\[Erro_{percentil} = \frac{|30.84144 - 31.489|}{30.84144} * 100 = 2.099\% \]
...
\[Erro_{percentil} = \frac{|5.553507 - 5.6115|}{5.553507} * 100 = 1.044\%\]
...
O segundo quartil(Q2) é a mediana já calculada no 1.1 que é 19.15, Já Q1, Q3 e IQR podem ser encontrados pelas respectivas fórmulas:

\[Q_1 = \frac{1(N+1)}{4} = \frac{81}{4} = 20.25\]

\[Q_2 = 19.15\]

\[Q_3 = \frac{3}{4} (N+1) = \frac{3}{4}*81 = 60.75\]

\[IQR = Q_3 - Q_1 = 60.75 - 20.25 = 40.50\]
